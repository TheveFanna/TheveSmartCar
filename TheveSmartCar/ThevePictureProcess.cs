...
namespace TheveSmartCar
{
    static class ThevePictureProcess
    {
        ...
        static string start = @"using ThevePictureProcessDll; using System.Windows.Forms;using System; public class PicProSpace { public void PicProMain() {";
        static string end = "}}";
